...
namespace SastImg.Client.Service.API
{
    ...
    public partial interface IImageApi
    {
        ...
        [Multipart] Task<IApiResponse> AddImageAsync([Query] long albumId,string title,StreamPart image,ICollection<long> tags,CancellationToken cancellationToken = default);
